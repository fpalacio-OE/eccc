...
serdef[,(deflators):=list(`imp-total imports of services-3800070-current prices`/`imp-total imports of services-3800070-chained (2007) dollars`*100,
...
serdef[,`:=`(sectorcode="CANADA",mnemonic="PM",code="NAT",mnem="")]
######################################################
#make agriculture                                    #
######################################################
